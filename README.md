...
- [ADR 0011: merged catalog](./docs/decisions/0011-merged-catalog.md) — accepted merge precedence, discovered/configured relationship union, and keyless-view key rules.
