...
This closes the last Milestone 1 backlog item ("Cover catalog parsing, merging, revisions, drift, and real SQL Server introspection with tests"). Milestone 1 — Catalog foundation is complete and CI-verified end to end.
