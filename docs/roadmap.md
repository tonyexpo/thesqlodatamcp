...
**Status:** In progress. The provider-neutral technical catalog model, deterministic structural hash, SQL Server catalog type mapper, complete table/view/column/key/index/foreign-key introspection, and semantic overlay Markdown/YAML import and validation (ADR 0010) are all accepted with real CI evidence (GitHub Actions runs [30031601860](https://github.com/tonyexpo/thesqlodatamcp/actions/runs/30031601860) and [32059087651](https://github.com/tonyexpo/thesqlodatamcp/actions/runs/32059087651)). Merging the overlay into the technical catalog (ADR 0011) is implemented and locally validated, pending CI. The remaining catalog lifecycle — capability/revision models, SQLite persistence, activation/rollback, and search — is pending.
