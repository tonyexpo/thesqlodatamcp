...
4. Preserve the software-architect and QA-lead ownership model: delegate production implementation to a dev-senior sub-agent (`gpt-5.6-terra` under Codex, `Sonnet-5` under Claude Code), then independently review, test, validate, and update documentation before acceptance.
